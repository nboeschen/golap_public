...
GPU_SELECT_DATA = GPU_SELECT_DATA.query("uncomp_bytes >= 2000000000")
...
for data in [GPU_SELECT_DATA,CPU_SELECT_DATA]:
    ...
    for dataflow,cur_data in data.groupby("dataflow"):
        ...
        # print(cur_data[["ratio_alt","chunk_bytes","efficiency"]])
        ...
        # for row in cur_data.itertuples():
        #     axes.text(row.ratio_alt, row.effective_bw, row.query, fontsize=20)
