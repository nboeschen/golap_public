...
for label,data in [
    ...
    for dataflow,cur_data in data.groupby("dataflow"):
        ...
        plt.scatter(cur_data["ratio_alt"], cur_data["effective_bw"], 300, edgecolors="#00000000", linewidths=2, marker=marker, alpha=0.7, label=f"{label} Dataset Column")
...
axes.set_ylabel("Effective Bandwidth [GiB/s, Log Scale]")
